(function webpackUniversalModuleDefinition(root, factory) {
  if (typeof exports === 'object' && typeof module === 'object')
    ...
    exports['ePub'] = factory(require('xmldom'),
        (function webpackLoadOptionalExternalModule() {
          try {
            return require('jszip');
          } catch (e) {}
    ...
    function(__WEBPACK_EXTERNAL_MODULE_42__, __WEBPACK_EXTERNAL_MODULE_72__) {
      ...
      /******/([
        ...
        /***/ (function(module, exports, __webpack_require__) {
           ...
           * @memberof Core
           */
          var requestAnimationFrame = exports.requestAnimationFrame = typeof window !=
          ...
          var COMMENT_NODE = 8;
          var DOCUMENT_NODE = 9;
          var _URL = typeof URL != 'undefined' ? URL : typeof window !=
          'undefined'
          ...
          function prefixed(unprefixed) {
            ...
            for (var i = 0; i < length; i++) {
              if (typeof document.body.style[prefixes[i] + lower] !=
                  'undefined') {
          ...
          function querySelectorByType(html, element, type) {
            ...
            if ( !query || query.length === 0) {
              ...
              for (var i = 0; i < query.length; i++) {
                if (query[i].getAttributeNS('http://www.idpf.org/2007/ops',
                    'type') === type || query[i].getAttribute('epub:type') ===
                    type) {
                  return query[i];
                }
              }
            ...
            _createClass(RangeObject, [
              {
                ...
                value: function selectNode(referenceNode) {
                  ...
                  var index = Array.prototype.indexOf.call(parent.childNodes,
                      referenceNode);
                ...
                value: function selectNodeContents(referenceNode) {
                  var end = referenceNode.childNodes[referenceNode.childNodes -
                  1];
                  var endIndex = referenceNode.nodeType === 3
            ...
            _createClass(EpubCFI, [
              {
                ...
                value: function checkType(cfi) {
                  ...
                  if (this.isCfiString(cfi)) {
                    ...
                    // Is a range object
                      ...
                      (typeof cfi === 'undefined' ? 'undefined' : _typeof(
                          cfi)) === 'object' &&
                    ...
                    return 'range';
                      ...
                      (typeof cfi === 'undefined' ? 'undefined' : _typeof(
                          cfi)) === 'object' && typeof cfi.nodeType !=
                      'undefined') {
                    // || typeof cfi === "function"
                    return 'node';
                  } else if (cfi &&
                      (typeof cfi === 'undefined' ? 'undefined' : _typeof(
                          cfi)) === 'object' && cfi instanceof EpubCFI) {
                    return 'EpubCFI';
                  } else {
                    return false;
                  }
                ...
                value: function step(node) {
                  var nodeType = node.nodeType === TEXT_NODE
                      ? 'text'
                      : 'element';
                ...
                value: function filteredStep(node, ignoreClass) {
                  ...
                  nodeType = filteredNode.nodeType === TEXT_NODE
                      ? 'text'
                      : 'element';
                ...
                value: function pathTo(node, offset, ignoreClass) {
                  ...
                  if (offset != null && offset >= 0) {
                    ...
                    if (segment.steps[segment.steps.length - 1].type !=
                        'text') {
                      segment.steps.push({
                        'type': 'text',
                        'index': 0,
                ...
                value: function equalStep(stepA, stepB) {
                  ...
                  if (stepA.index === stepB.index && stepA.id === stepB.id &&
                ...
                value: function fromRange(range, base, ignoreClass) {
                  ...
                  if (ignoreClass) {
                    ...
                    needsIgnoring = start.ownerDocument.querySelector(
                        '.' + ignoreClass) != null;
                  }
                  ...
                  if (range.collapsed) {
                    if (needsIgnoring) {
                      startOffset = this.patchOffset(start, startOffset,
                          ignoreClass);
                    }
                    ...
                    for (i = 0; i < len; i++) {
                      if (this.equalStep(cfi.start.steps[i],
                          cfi.end.steps[i])) {
                        if (i === len - 1) {
                ...
                value: function filter(anchor, ignoreClass) {
                  ...
                  if (anchor.nodeType === TEXT_NODE) {
                    ...
                    needsIgnoring = anchor.parentNode.classList.contains(
                        ignoreClass);
                  } else {
                    isText = false;
                  ...
                  if (needsIgnoring && isText) {
                    ...
                    if (previousSibling && previousSibling.nodeType ===
                        TEXT_NODE) {
                      sibling = previousSibling;
                    } else if (nextSibling && nextSibling.nodeType ===
                        TEXT_NODE) {
                      sibling = nextSibling;
                    }
                ...
                value: function patchOffset(anchor, offset, ignoreClass) {
                  ...
                  while (curr.previousSibling) {
                    if (curr.previousSibling.nodeType === ELEMENT_NODE) {
                      ...
                      if (curr.previousSibling.classList.contains(
                          ignoreClass)) {
                ...
                value: function normalizedMap(children, nodeType, ignoreClass) {
                  ...
                  for (i = 0; i < len; i++) {
                    ...
                    if (i > 0 && currNodeType === TEXT_NODE && prevNodeType ===
                        TEXT_NODE) {
                      // join text nodes
                      output[i] = prevIndex;
                ...
                value: function filteredPosition(anchor, ignoreClass) {
                  ...
                  if (anchor.nodeType === ELEMENT_NODE) {
                    children = anchor.parentNode.children;
                    map = this.normalizedMap(children, ELEMENT_NODE,
                        ignoreClass);
                  } else {
  ...
  */
                ...
                value: function walkToNode(steps, _doc, ignoreClass) {
                  ...
                  for (i = 0; i < len; i++) {
                    ...
                    if (step.type === 'element') {
                      ...
                      container = this.textNodes(container,
                          ignoreClass)[step.index];
                    }
                    if ( !container) {
                ...
                value: function findNode(steps, _doc, ignoreClass) {
                  ...
                  if ( !ignoreClass && typeof doc.evaluate != 'undefined') {
                    ...
                    container = doc.evaluate(xpath, doc, null,
                ...
                value: function fixMiss(steps, offset, _doc, ignoreClass) {
                  ...
                  var map = this.normalizedMap(children, TEXT_NODE,
                      ignoreClass);
                  var child;
                  var len;
                ...
                value: function toRange(_doc, ignoreClass) {
                  ...
                  var needsIgnoring = ignoreClass ? doc.querySelector(
                      '.' + ignoreClass) != null : false;
                  var missed;
                  ...
                  if (startContainer) {
                    try {
                      ...
                      missed = this.fixMiss(startSteps, start.terminal.offset,
                          doc, needsIgnoring ? ignoreClass : null);
                  ...
                  if (endContainer) {
                    try {
                      ...
                      missed = this.fixMiss(endSteps, cfi.end.terminal.offset,
                          doc, needsIgnoring ? ignoreClass : null);
                ...
                value: function isCfiString(str) {
                  if (typeof str === 'string' && str.indexOf('epubcfi(') ===
                      0 && str[str.length - 1] === ')') {
                    return true;
                  }
...
// Dom events to listen for
        ...
        /***/ (function(module, exports, __webpack_require__) {
          ...
          on = function on(type, listener) {
            ...
            if ( !data[type]) data[type] = listener; else if (_typeof(
                data[type]) === 'object') data[type].push(
                listener); else data[type] = [data[type], listener];
          ...
          off = function off(type, listener) {
            ...
            if ((typeof listeners === 'undefined' ? 'undefined' : _typeof(
                listeners)) === 'object') {
              for (i = 0; candidate = listeners[i]; ++i) {
                if (candidate === listener || candidate.__eeOnceListener__ ===
                    listener) {
                  if (listeners.length === 2) data[type] = listeners[i
                      ? 0
                      : 1]; else listeners.splice(i, 1);
                }
              }
            } else {
              if (listeners === listener || listeners.__eeOnceListener__ ===
                  listener) {
                delete data[type];
              }
            }
          ...
          module.exports = exports = function exports(o) {
            return o == null ? create(base) : defineProperties(Object(o),
                descriptors);
          };
        ...
        /***/ (function(module, exports, __webpack_require__) {
          ...
          var Url = function() {
            function Url(urlString, baseString) {
              ...
              if ( !absolute && baseString !== false && typeof baseString !==
                  'string' && window && window.location) {
            ...
            _createClass(Url, [
              {
                ...
                value: function resolve(what) {
                  ...
                  fullpath = _pathWebpack2.default.resolve(this.directory,
                      what);
...
// Resolves . and .. elements in a path with directory names
          function normalizeStringPosix(path, allowAboveRoot) {
            ...
            for (var i = 0; i <= path.length; ++i) {
              if (i < path.length) code = path.charCodeAt(i); else if (code ===
                  47 /*/*/) break; else code = 47 /*/*/;
              if (code === 47 /*/*/) {
                if (lastSlash === i - 1 || dots === 1) {
                  ...
                  if (res.length > 0) res += '/' +
                      path.slice(lastSlash + 1, i); else res = path.slice(
                      lastSlash + 1, i);
                }
                lastSlash = i;
                dots = 0;
          ...
          function _format(sep, pathObject) {
            ...
            var base = pathObject.base || (pathObject.name || '') +
                (pathObject.ext || '');
            if ( !dir) {
              return base;
            }
          ...
          var posix = {
            ...
            resolve: function resolve() {
              ...
              // Normalize the path
              resolvedPath = normalizeStringPosix(resolvedPath,
                  !resolvedAbsolute);

              if (resolvedAbsolute) {
                if (resolvedPath.length > 0) return '/' +
                    resolvedPath; else return '/';
            ...
            normalize: function normalize(path) {
              ...
              var trailingSeparator = path.charCodeAt(path.length - 1) ===
                  47 /*/*/;
            ...
            join: function join() {
              ...
              for (var i = 0; i < arguments.length; ++i) {
                ...
                assertPath(arg);
                if (arg.length > 0) {
                  if (joined === undefined) joined = arg; else joined += '/' +
                      arg;
                }
              }
            ...
            relative: function relative(from, to) {
              ...
              for (; i <= length; ++i) {
                ...
                if (fromCode !== toCode) break; else if (fromCode ===
                    47 /*/*/) lastCommonSep = i;
              }
              ...
              if (out.length > 0) return out +
                  to.slice(toStart + lastCommonSep); else {
            ...
            basename: function basename(path, ext) {
              if (ext !== undefined && typeof ext !==
                  'string') throw new TypeError(
              ...
              if (ext !== undefined && ext.length > 0 && ext.length <=
                  path.length) {
                ...
                if (start === end) end = firstNonSlashEnd; else if (end ===
                    -1) end = path.length;
            ...
            extname: function extname(path) {
              ...
              for (var i = path.length - 1; i >= 0; --i) {
                ...
                if (code === 46 /*.*/) {
                  ...
                  if (startDot === -1) startDot = i; else if (preDotState !==
                      1) preDotState = 1;
                } else if (startDot !== -1) {
              ...
              if (startDot === -1 || end === -1 ||
                  ...
                  preDotState === 1 && startDot === end - 1 && startDot ===
                  startPart + 1) {
                return '';
              }
            ...
            format: function format(pathObject) {
              if (pathObject === null ||
                  (typeof pathObject === 'undefined' ? 'undefined' : _typeof(
                      pathObject)) !== 'object') {
                throw new TypeError(
            ...
            parse: function parse(path) {
              ...
              if (startDot === -1 || end === -1 ||
                ...
                if (end !== -1) {
                  if (startPart === 0 &&
                      isAbsolute) ret.base = ret.name = path.slice(1,
                      end); else ret.base = ret.name = path.slice(startPart,
                      end);
                }
              } else {
              ...
              if (startPart > 0) ret.dir = path.slice(0,
                  startPart - 1); else if (isAbsolute) ret.dir = '/';
                    ...
                    if (task) {
                      ...
                      if (result && typeof result['then'] === 'function') {
                        ...
                        return result.then(function() {
                          inwait.deferred.resolve.apply(this.context,
                              arguments);
                        }.bind(this), function() {
 ...
 */
        ...
        /***/ (function(module, exports, __webpack_require__) {
          ...
          var isWebkit = hasNavigator && !isChrome &&
            ...
            _createClass(Contents, [
              {
                ...
                value: function overflowX(overflow) {
                  ...
                  return this.window.getComputedStyle(
                      this.documentElement)['overflowX'];
                },
                ...
                value: function overflowY(overflow) {
                  ...
                  return this.window.getComputedStyle(
                      this.documentElement)['overflowY'];
                },
   ...
   */
                  if ($viewport && $viewport.hasAttribute('content')) {
                    ...
                    if (_width2 && _width2.length && typeof _width2[1] !==
                        'undefined') {
                      parsed.width = _width2[1];
                    }
                    if (_height2 && _height2.length && typeof _height2[1] !==
                        'undefined') {
                      parsed.height = _height2[1];
                    }
                    if (_scale2 && _scale2.length && typeof _scale2[1] !==
                        'undefined') {
                      parsed.scale = _scale2[1];
                    }
                    if (_minimum2 && _minimum2.length && typeof _minimum2[1] !==
                        'undefined') {
                      parsed.minimum = _minimum2[1];
                    }
                    if (_maximum2 && _maximum2.length && typeof _maximum2[1] !==
                        'undefined') {
                      parsed.maximum = _maximum2[1];
                    }
                    if (_scalable2 && _scalable2.length &&
                  ...
                  if (options) {
                    ...
                    if ( !$viewport) {
                      ...
                      this.document.querySelector('head').
                ...
                value: function resizeCheck() {
                  ...
                  if (width != this._size.width || height !=
                      this._size.height) {
                ...
                value: function transitionListeners() {
                  ...
                  this.document.addEventListener('transitionend',
                      this._resizeCheck);
                },
                ...
                value: function locationOf(target, ignoreClass) {
                    ...
                    if (range) {
                      try {
                        if ( !range.endContainer || range.startContainer ==
                          ...
                          var pos = range.startContainer.textContent.indexOf(
                              ' ', range.startOffset);
                          if (pos == -1) {
                  ...
                  } else if (typeof target === 'string' && target.indexOf('#') >
                      -1) {
                ...
                value: function addStylesheet(src) {
                  return new Promise(function(resolve, reject) {
                    ...
                    $stylesheet.onload = $stylesheet.onreadystatechange = function() {
                      if ( !ready && ( !this.readyState || this.readyState ==
                          'complete')) {
                        ready = true;
                        // Let apply
                        setTimeout(function() {
                ...
                value: function addStylesheetRules(rules) {
                  ...
                  if (Object.prototype.toString.call(rules) ===
                      '[object Array]') {
                    for (var i = 0, rl = rules.length; i < rl; i++) {
                      ...
                      if (Object.prototype.toString.call(rule[1][0]) ===
                          '[object Array]') {
                        rule = rule[1];
                        j = 0;
                      }
                    ...
                    selectors.forEach(function(selector) {
                      ...
                      if (Array.isArray(definition)) {
                        definition.forEach(function(item) {
                          ...
                          styleSheet.insertRule(selector + '{' + result + '}',
                              styleSheet.cssRules.length);
                        });
                      } else {
                ...
                value: function addEventListeners() {
                  ...
                  _constants.DOM_EVENTS.forEach(function(eventName) {
                    this.document.addEventListener(eventName,
                        this._triggerEvent, { passive: true });
                  }, this);
                },
                ...
                value: function addSelectionListeners() {
                  ...
                  this.document.addEventListener('selectionchange',
                      this._onSelectionChange, { passive: true });
                },
                ...
                value: function triggerSelectedEvent(selection) {
                  ...
                  if (selection && selection.rangeCount > 0) {
                    ...
                    if ( !range.collapsed) {
                      ...
                      cfirange = new _epubcfi2.default(range,
                          this.cfiBase).toString();
                      this.emit(_constants.EVENTS.CONTENTS.SELECTED, cfirange);
                      this.emit(_constants.EVENTS.CONTENTS.SELECTED_RANGE,
                          range);
                    }
                  }
                },
                ...
                value: function cfiFromRange(range, ignoreClass) {
                  return new _epubcfi2.default(range, this.cfiBase,
                      ignoreClass).toString();
                },
                ...
                value: function cfiFromNode(node, ignoreClass) {
                  return new _epubcfi2.default(node, this.cfiBase,
                      ignoreClass).toString();
                },
                ...
                value: function columns(width, height, columnWidth, gap) {
                  ...
                  var axis = writingMode.indexOf('vertical') === 0
                      ? 'vertical'
                      : 'horizontal';
                ...
                value: function scaler(scale, offsetX, offsetY) {
                  ...
                  if (offsetX >= 0 || offsetY >= 0) {
                    translateStr = ' translate(' + (offsetX || 0) + 'px, ' +
                        (offsetY || 0) + 'px )';
                  }
                ...
                value: function fit(width, height) {
                  ...
                  var scale = widthScale < heightScale
                      ? widthScale
                      : heightScale;
                  ...
                  this.css('background-size',
                      viewportWidth * scale + 'px ' + viewportHeight * scale +
                      'px');
                ...
                value: function writingMode(mode) {
                  ...
                  return this.window.getComputedStyle(
                      this.documentElement)[WRITING_MODE] || '';
                },
                ...
                value: function destroy() {
                  ...
                  this.document.removeEventListener('transitionend',
                      this._resizeCheck);
            ...
            _createClass(DefaultViewManager, [
              {
                ...
                value: function render(element, size) {
                  ...
                  if (typeof this.settings.fullsize === 'undefined' && tag &&
   ...
   */
                ...
                value: function onOrientationChange(e) {
                  ...
                  this.orientationTimeout = setTimeout(function() {
                    ...
                    this.emit(_constants.EVENTS.MANAGERS.ORIENTATION_CHANGE,
                        orientation);
                  }.bind(this), 500);
                },
              }, {
                ...
                value: function resize(width, height, epubcfi) {
                  ...
                  if (this.orientationTimeout && this.winBounds.width ===
                      this.winBounds.height) {
                    // reset the stage size for next resize
                    this._stageSize = undefined;
                    return;
                  }

                  if (this._stageSize && this._stageSize.width ===
                      stageSize.width && this._stageSize.height ===
                      stageSize.height) {
                ...
                value: function moveTo(offset) {
                  ...
                  if ( !this.isPaginated) {
                    ...
                    distX = Math.floor(offset.left / this.layout.delta) *
                        this.layout.delta;

                    if (distX + this.layout.delta >
                ...
                value: function next() {
                  ...
                  } else if (this.isPaginated && this.settings.axis ===
                      'horizontal' && dir === 'rtl') {
                ...
                value: function prev() {
                  ...
                  if (prev) {
                    ...
                    return this.prepend(prev).then(function() {
                      ...
                      if (this.isPaginated && this.settings.axis ===
                          'horizontal') {
                        if (this.settings.direction === 'rtl') {
                          this.scrollTo(0, 0, true);
                        } else {
                          this.scrollTo(
                              this.container.scrollWidth - this.layout.delta, 0,
                              true);
                        }
                      }
                      this.views.show();
                ...
                value: function scrolledLocation() {
                  ...
                  var pageHeight = container.height < window.innerHeight
                      ? container.height
                      : window.innerHeight;
                  ...
                  var sections = visible.map(function(view) {
                    ...
                    var totalPages = _this4.layout.count(height,
                        pageHeight).pages;
                    ...
                    var mapping = _this4.mapping.page(view.contents,
                        view.section.cfiBase, startPos, endPos);
                ...
                value: function paginatedLocation() {
                  ...
                  var sections = visible.map(function(view) {
                    ...
                    var mapping = _this5.mapping.page(view.contents,
                        view.section.cfiBase, start, end);
                ...
                value: function isVisible(
                    view, offsetPrev, offsetNext, _container) {
                  var position = view.position();
                  var container = _container || this.bounds();

                  if (this.settings.axis === 'horizontal' && position.right >
                      container.left - offsetPrev && position.left <
                      container.right + offsetNext) {
                ...
                value: function updateLayout() {
                  ...
                  if ( !this.isPaginated) {
                    this.layout.calculate(this._stageSize.width,
                        this._stageSize.height);
                  } else {
                    this.layout.calculate(this._stageSize.width,
                        this._stageSize.height, this.settings.gap);
                ...
                value: function setLayout(layout) {
                  ...
                  this.mapping = new _mapping2.default(layout.props,
                      this.settings.direction, this.settings.axis);
                ...
                value: function updateFlow(flow) {
                  var defaultScrolledOverflow = arguments.length > 1 &&
                  arguments[1] !== undefined ? arguments[1] : 'auto';

                  var isPaginated = flow === 'paginated' || flow === 'auto';

                  this.isPaginated = isPaginated;

                  if (flow === 'scrolled-doc' || flow ===
                      'scrolled-continuous' || flow === 'scrolled') {
                ...
                value: function direction() {
                  var dir = arguments.length > 0 && arguments[0] !== undefined
                      ? arguments[0]
                      : 'ltr';
...
//level2
          ...
          NamedNodeMap.prototype = {
            ...
            getNamedItemNS: function getNamedItemNS(namespaceURI, localName) {
              ...
              while (i--) {
                var node = this[i];
                if (node.localName == localName && node.namespaceURI ==
                    namespaceURI) {
                  return node;
                }
              }
          ...
          DOMImplementation.prototype = {
            hasFeature: function hasFeature( /* string */feature, /* string */
                                             version) {
          ...
          Node.prototype = {
            ...
            normalize: function normalize() {
              ...
              while (child) {
                ...
                if (next && next.nodeType == TEXT_NODE && child.nodeType ==
                    TEXT_NODE) {
          ...
          Document.prototype = {
            ...
            insertBefore: function insertBefore(newChild, refChild) {
              ...
              return _insertBefore(this, newChild,
                  refChild), newChild.ownerDocument = this, newChild;
            },
            removeChild: function removeChild(oldChild) {
          ...
          function serializeToString(
              node, buf, isHTML, nodeFilter, visibleNamespaces) {
            if (nodeFilter) {
                ...
                for (var i = 0; i < len; i++) {
                  ...
                  if (attr.prefix == 'xmlns') {
                    visibleNamespaces.push(
                        { prefix: attr.localName, namespace: attr.value });
                  } else if (attr.nodeName == 'xmlns') {
                    visibleNamespaces.push(
                        { prefix: '', namespace: attr.value });
                  }
                }
                for (var i = 0; i < len; i++) {
                  var attr = attrs.item(i);
                  ...
                  serializeToString(attr, buf, isHTML, nodeFilter,
                      visibleNamespaces);
                }
...
//					attributes:1,childNodes:1,parentNode:1,documentElement:1,doctype,};
          function _cloneNode(doc, node, deep) {
            ...
            for (var n in node) {
              var v = node[n];
              if ((typeof v === 'undefined' ? 'undefined' : _typeof(v)) !=
                  'object') {
                if (v != node2[n]) {
                  node2[n] = v;
                }
...
// Default View Managers
            ...
            _createClass(Rendition, [
              {
                ...
                value: function start() {
                  ...
                  this.manager.on(_constants.EVENTS.MANAGERS.ADDED,
                      this.afterDisplayed.bind(this));
                  this.manager.on(_constants.EVENTS.MANAGERS.REMOVED,
                      this.afterRemoved.bind(this));

                  // Listen for resizing
                  this.manager.on(_constants.EVENTS.MANAGERS.RESIZED,
                      this.onResized.bind(this));

                  // Listen for rotation
                  this.manager.on(_constants.EVENTS.MANAGERS.ORIENTATION_CHANGE,
                      this.onOrientationChange.bind(this));

                  // Listen for scroll changes
                  this.manager.on(_constants.EVENTS.MANAGERS.SCROLLED,
  ...
  */
                ...
                value: function afterDisplayed(view) {
                  ...
                  view.on(_constants.EVENTS.VIEWS.MARK_CLICKED,
                      function(cfiRange, data) {
                        return _this2.triggerMarkEvent(cfiRange, data,
                            view.contents);
                      });

                  this.hooks.render.trigger(view, this).then(function() {
                    if (view.contents) {
                      _this2.hooks.content.trigger(view.contents, _this2).
                          then(function() {
                            /**
                             ...
                             * @memberof Rendition
                             */
                            _this2.emit(_constants.EVENTS.RENDITION.RENDERED,
                                view.section, view);
                          });
                    } else {
                      _this2.emit(_constants.EVENTS.RENDITION.RENDERED,
                ...
                value: function afterRemoved(view) {
                  ...
                  this.hooks.unloaded.trigger(view, this).then(function() {
                     ...
                     * @memberof Rendition
                     */
                    _this3.emit(_constants.EVENTS.RENDITION.REMOVED,
                        view.section, view);
                  });
                },
                ...
                value: function onOrientationChange(orientation) {
                   ...
                   * @memberof Rendition
                   */
                  this.emit(_constants.EVENTS.RENDITION.ORIENTATION_CHANGE,
                      orientation);
                },
                ...
                value: function determineLayoutProperties(metadata) {
                  var properties;
                  var layout = this.settings.layout || metadata.layout ||
                      'reflowable';
                  var spread = this.settings.spread || metadata.spread ||
                      'auto';
                  var orientation = this.settings.orientation ||
                      metadata.orientation || 'auto';
                  var flow = this.settings.flow || metadata.flow || 'auto';
                  var viewport = metadata.viewport || '';
                  var minSpreadWidth = this.settings.minSpreadWidth ||
                      metadata.minSpreadWidth || 800;
                  var direction = this.settings.direction ||
                      metadata.direction || 'ltr';

                  if ((this.settings.width === 0 || this.settings.width > 0) &&
                      (this.settings.height === 0 || this.settings.height >
                          0)) {
                ...
                value: function flow(_flow2) {
                  var _flow = _flow2;
                  if (_flow2 === 'scrolled' || _flow2 === 'scrolled-doc' ||
                ...
                value: function layout(settings) {
                  ...
                  if (settings) {
                    ...
                    this._layout.spread(settings.spread,
                        this.settings.minSpreadWidth);

                    // this.mapping = new Mapping(this._layout.props);

                    this._layout.on(_constants.EVENTS.LAYOUT.UPDATED,
                        function(props, changed) {
                          _this4.emit(_constants.EVENTS.RENDITION.LAYOUT, props,
                              changed);
                        });
                  }
                ...
                value: function reportLocation() {
                  return this.q.enqueue(function reportedLocation() {
                    requestAnimationFrame(function reportedLocationAfterRAF() {
                      ...
                      if (location && location.then && typeof location.then ===
                          'function') {
                        location.then(function(result) {
                          ...
                          this.emit(_constants.EVENTS.RENDITION.RELOCATED,
                              this.location);
                        }.bind(this));
                      } else if (location) {
                ...
                value: function located(location) {
                  ...
                  if (end.index === this.book.spine.last().index &&
                      located.end.displayed.page >=
                      located.end.displayed.total) {
                    located.atEnd = true;
                  }
                ...
                value: function triggerSelectedEvent(cfirange, contents) {
                   ...
                   * @memberof Rendition
                   */
                  this.emit(_constants.EVENTS.RENDITION.SELECTED, cfirange,
                      contents);
                },
                ...
                value: function triggerMarkEvent(cfiRange, data, contents) {
                   ...
                   * @memberof Rendition
                   */
                  this.emit(_constants.EVENTS.RENDITION.MARK_CLICKED, cfiRange,
                      data, contents);
                },
                ...
                value: function adjustImages(contents) {
                  ...
                  var computed = contents.window.getComputedStyle(
                      contents.content, null);
                  var height = (contents.content.offsetHeight -
                      (parseFloat(computed.paddingTop) +
                          parseFloat(computed.paddingBottom))) * .95;
                  var horizontalPadding = parseFloat(computed.paddingLeft) +
                ...
                value: function handleLinks(contents) {
                  ...
                  if (contents) {
                    contents.on(_constants.EVENTS.CONTENTS.LINK_CLICKED,
                        function(href) {
            ...
            _createClass(Mapping, [
              {
                ...
                value: function section(view) {
                  ...
                  var map = this.rangeListToCfiList(view.section.cfiBase,
                      ranges);
                ...
                value: function page(contents, cfiBase, start, end) {
                  var root = contents && contents.document
                  ...
                  if (this._dev === true) {
                    ...
                    r.setStart(startRange.startContainer,
                ...
                value: function walk(root, func) {
                  ...
                  var treeWalker = document.createTreeWalker(root,
                      NodeFilter.SHOW_TEXT, safeFilter, false);
                  var node;
                  var result;
                  while (node = treeWalker.nextNode()) {
                    result = func(node);
                ...
                value: function findStart(root, start, end) {
                  ...
                  while (stack.length) {
                    ...
                    found = this.walk($el, function(node) {
                      ...
                      } else if (_this.horizontal && _this.direction ===
                          'rtl') {
                ...
                value: function findEnd(root, start, end) {
                  ...
                  while (stack.length) {
                    ...
                    found = this.walk($el, function(node) {
                      ...
                      } else if (_this2.horizontal && _this2.direction ===
                          'rtl') {
                ...
                value: function rangePairToCfiPair(cfiBase, rangePair) {
                  ...
                  var startCfi = new _epubcfi2.default(startRange,
                      cfiBase).toString();
                  var endCfi = new _epubcfi2.default(endRange,
                      cfiBase).toString();
          ...
          var IframeView = function() {
            function IframeView(section, options) {
              ...
              this.settings = (0, _core.extend)({
                ignoreClass: '',
                axis: options.layout && options.layout.props.flow === 'scrolled'
                    ? 'vertical'
                    : 'horizontal',
                direction: undefined,
                width: 0,
            ...
            _createClass(IframeView, [
              {
                ...
                value: function lock(what, width, height) {
                  ...
                  if (what == 'height' && (0, _core.isNumber)(height)) {
                    this.lockedHeight = height - elBorders.height -
                        iframeBorders.height;
                    // this.resize(width, this.lockedHeight);
                  }

                  if (what === 'both' && (0, _core.isNumber)(width) &&
                ...
                value: function expand(force) {
                  ...
                  // Expand Horizontally
                    ...
                    if (width % this.layout.pageWidth > 0) {
                      width = Math.ceil(width / this.layout.pageWidth) *
                          this.layout.pageWidth;
                    }

                    if (this.settings.forceEvenPages) {
                      columns = width / this.layout.pageWidth;
                      if (this.layout.divisor > 1 && this.layout.name ===
                          'reflowable' && columns % 2 > 0) {
                        // add a blank page
                  ...
                  if (this._needsReframe || width != this._width || height !=
                      this._height) {
                ...
                value: function reframe(width, height) {
                  ...
                  var widthDelta = this.prevBounds ? width -
                      this.prevBounds.width : width;
                  var heightDelta = this.prevBounds ? height -
                      this.prevBounds.height : height;
                ...
                value: function load(contents) {
                  ...
                  if (this.settings.method === 'blobUrl') {
                    this.blobUrl = (0, _core.createBlobUrl)(contents,
                        'application/xhtml+xml');
                ...
                value: function onLoad(event, promise) {
                  ...
                  this.contents = new _contents2.default(this.document,
                      this.document.body, this.section.cfiBase,
                      this.section.index);
                  ...
                  this.contents.on(_constants.EVENTS.CONTENTS.RESIZE,
                      function(e) {
                        if (_this3.displayed && _this3.iframe) {
                          _this3.expand();
                          if (_this3.contents) {
                ...
                value: function locationOf(target) {
                  ...
                  var targetPos = this.contents.locationOf(target,
                ...
                value: function highlight(cfiRange) {
                  ...
                  var className = arguments.length > 3 && arguments[3] !==
                  undefined ? arguments[3] : 'epubjs-hl';
                  var styles = arguments.length > 4 && arguments[4] !==
                  ...
                  var emitter = function emitter() {
                    _this4.emit(_constants.EVENTS.VIEWS.MARK_CLICKED, cfiRange,
                        data);
                  };
                  ...
                  var m = new _marksPane.Highlight(range, className, data,
                      attributes);
                ...
                value: function underline(cfiRange) {
                  ...
                  var className = arguments.length > 3 && arguments[3] !==
                  undefined ? arguments[3] : 'epubjs-ul';
                  var styles = arguments.length > 4 && arguments[4] !==
                  undefined ? arguments[4] : {};
                  ...
                  var range = this.contents.range(cfiRange);
                  var emitter = function emitter() {
                    _this5.emit(_constants.EVENTS.VIEWS.MARK_CLICKED, cfiRange,
                        data);
                  };
                  ...
                  var m = new _marksPane.Underline(range, className, data,
                      attributes);
                  var h = this.pane.addMark(m);
                ...
                value: function mark(cfiRange) {
                  ...
                  var parent = container.nodeType === 1
                      ? container
                      : container.parentNode;

                  var emitter = function emitter(e) {
                    _this6.emit(_constants.EVENTS.VIEWS.MARK_CLICKED, cfiRange,
                        data);
                  };
                  ...
                  if (this.layout.name === 'pre-paginated' ||
                    ...
                    for (var i = 0; i != rects.length; i++) {
                      ...
                      if ( !left || rect.left < left) {
                        left = rect.left;
                        // right = rect.right;
                        right = Math.ceil(left / this.layout.props.pageWidth) *
                            this.layout.props.pageWidth - this.layout.gap / 2;
                        top = rect.top;
                      }
                    }
                  }
            ...
            function ContinuousViewManager(options) {
              ...
              var _this = _possibleConstructorReturn(this,
                  (ContinuousViewManager.__proto__ ||
                      Object.getPrototypeOf(ContinuousViewManager)).call(this,
                      options));
              ...
              if (options.settings.gap != 'undefined' &&
            ...
            _createClass(ContinuousViewManager, [
              {
                key: 'display',
                value: function display(section, target) {
                  return _default2.default.prototype.display.call(this, section,
                ...
                value: function update(_offset) {
                  ...
                  var viewsLength = views.length;
                  var visible = [];
                  var offset = typeof _offset != 'undefined'
                      ? _offset
                  ...
                  for (var i = 0; i < viewsLength; i++) {
                    ...
                    if (isVisible === true) {
                      ...
                      if ( !view.displayed) {
                        var displayed = view.display(this.request).
                            then(function(view) {
                              view.show();
                            }, function(err) {
                              view.hide();
                ...
                value: function check(_offsetLeft, _offsetTop) {
                  ...
                  if (newViews.length) {
                    return Promise.all(promises).then(function() {
                      if (_this6.layout.name === 'pre-paginated' &&
                          _this6.layout.props.spread) {
                        return _this6.check();
                      }
                    }).then(function() {
                ...
                value: function erase(view, above) {
                  ...
                  if (above) {
                    if (this.settings.axis === 'vertical') {
                      ...
                      this.scrollTo(prevLeft - Math.floor(bounds.width), 0,
                          true);
                    }
                  }
                },
                ...
                value: function addEventListeners(stage) {
                  ...
                  if (this.isPaginated && this.settings.snap) {
                    this.snapper = new _snap2.default(this,
                        this.settings.snap && _typeof(this.settings.snap) ===
                        'object' && this.settings.snap);
                  }
                },
              }, {
                ...
                value: function scrolled() {
                  ...
                  this.afterScrolled = setTimeout(function() {
                    ...
                    if (this.snapper && this.snapper.supportsTouch &&
                ...
                value: function next() {
                  ...
                  var dir = this.settings.direction;
                  var delta = this.layout.props.name === 'pre-paginated' &&
                ...
                value: function updateFlow(flow) {
                  ...
                  _get(ContinuousViewManager.prototype.__proto__ ||
                      Object.getPrototypeOf(ContinuousViewManager.prototype),
                      'updateFlow', this).call(this, flow, 'scroll');
        ...
        /***/ (function(module, exports, __webpack_require__) {
          ...
          var Book = function() {
            function Book(url, options) {
              ...
              if (typeof options === 'undefined' && typeof url !== 'string' &&
               ...
               * @memberof Book
               */
              this.locations = new _locations2.default(this.spine,
                  this.load.bind(this));
            ...
            _createClass(Book, [
              {
                ...
                value: function openEpub(data, encoding) {
                  ...
                  return this.unarchive(data,
                      encoding || this.settings.encoding).then(function() {
                ...
                value: function unpack(packaging) {
                    ...
                    this.load(this.url.resolve(IBOOKS_DISPLAY_OPTIONS_PATH)).
                        then(function(xml) {
                          _this6.displayOptions = new _displayoptions2.default(
                              xml);
                          _this6.loading.displayOptions.resolve(
                  ...
                  this.spine.unpack(this.packaging, this.resolve.bind(this),
                    ...
                    return new Promise(function(resolve, reject) {
                      ...
                      if (packaging.pageList) {
                        _this7.pageList = new _pagelist2.default(
                            packaging.pageList); // TODO: handle page lists from Manifest
                      }
                ...
                value: function store(name) {
                  ...
                  var replacementsSetting = this.settings.replacements &&
                      this.settings.replacements !== 'none';
                  // Save original url
                  var originalUrl = this.url;
                  // Save original request method
                  var requester = this.settings.requestMethod ||
                      _request3.default.bind(this);
                  // Create new Store
                  this.storage = new _store2.default(name, requester,
                  ...
                  this.opened.then(function() {
                    if (_this8.archived) {
                      _this8.storage.requester = _this8.archive.request.bind(
                          _this8.archive);
                    }
                    // Substitute hook
                    var substituteResources = function substituteResources(
                        output, section) {
                      section.output = _this8.resources.substitute(output,
                          section.url);
                    };

                    // Set to use replacements
                    _this8.resources.settings.replacements = replacementsSetting ||
                        'blobUrl';
                    ...
                    _this8.storage.on('offline', function() {
                      ...
                      _this8.spine.hooks.serialize.register(
                          substituteResources);
                    });
                    ...
                    _this8.storage.on('online', function() {
                      ...
                      // Remove hook
                      _this8.spine.hooks.serialize.deregister(
                          substituteResources);
                    });
                  });
                ...
                value: function replacements() {
                  ...
                  this.spine.hooks.serialize.register(
                      function(output, section) {
                        section.output = _this10.resources.substitute(output,
                            section.url);
                      });
                ...
                value: function key(identifier) {
                  var ident = identifier ||
                      this.packaging.metadata.identifier || this.url.filename;
...
// eslint-disable-next-line no-empty-function
        ...
        /***/ (function(module, exports, __webpack_require__) {
          ...
          module.exports = function(value) {
            if ( !isValue(value)) throw new TypeError(
...
// Deprecated
        ...
        /***/ (function(module, exports, __webpack_require__) {
          ...
          module.exports = function() {
            ...
            return str.contains('dwa') === true && str.contains('foo') ===
                false;
          };
            ...
            _createClass(Spine, [
              {
                ...
                value: function unpack(_package, resolver, canonical) {
                  ...
                  this.items.forEach(function(item, index) {
                    ...
                    item.cfiBase = _this.epubcfi.generateChapterComponent(
                        _this.spineNodeIndex, item.index, item.idref);
                    ...
                    if (manifestItem) {
                      ...
                      if (manifestItem.properties.length) {
                        item.properties.push.apply(item.properties,
                ...
                value: function get(target) {
                  ...
                  if (typeof target === 'undefined') {
                    ...
                    index = cfi.spinePos;
                  } else if (typeof target === 'number' || isNaN(target) ===
                      false) {
                    index = target;
                ...
                key: 'each',
                value: function each() {
                  return this.spineItems.forEach.apply(this.spineItems,
                      arguments);
                },
                    ...
                    while (pos != -1) {
                      ...
                      if (pos != -1) {
                        ...
                        if (node.textContent.length < limit) {
                          ...
                          excerpt = node.textContent.substring(pos - limit / 2,
                              pos + limit / 2);
                          excerpt = '...' + excerpt + '...';
                        }
        ...
        /***/ (function(module, exports, __webpack_require__) {
          ...
          DOMParser.prototype.parseFromString = function(source, mimeType) {
            ...
            sax.errorHandler = buildErrorHandler(errorHandler, domBuilder,
                locator);
...
//console.log('#\n\n\n\n\n\n\n####')
          ...
          DOMHandler.prototype = {
            startDocument: function startDocument() {
              this.doc = new DOMImplementation().createDocument(null, null,
                  null);
              if (this.locator) {
            ...
            error: function error(_error) {
              console.error('[xmldom error]\t' + _error,
                  _locator(this.locator));
            },
            fatalError: function fatalError(error) {
              console.error('[xmldom fatalError]\t' + error,
                  _locator(this.locator));
              throw error;
            },
          };
...
//if(typeof require == 'function'){
          ...
          var DOMImplementation = exports.DOMImplementation = __webpack_require__(
...
//S_ATTR_SPACE,	S_ATTR_END,	S_TAG_SPACE, S_TAG_CLOSE
          ...
          XMLReader.prototype = {
            parse: function parse(source, defaultNSMap, entityMap) {
              ...
              _parse(source, defaultNSMap, entityMap, domBuilder,
                  this.errorHandler);
          ...
          function _parse(
              source, defaultNSMapCopy, entityMap, domBuilder, errorHandler) {
              ...
              try {
                ...
                switch (source.charAt(tagStart + 1)) {
                  case '/':
                    ...
                    var endIgnoreCaseMach = endMatch || config.tagName &&
                        config.tagName.toLowerCase() == tagName.toLowerCase();
                    if (endIgnoreCaseMach) {
                      domBuilder.endElement(config.uri, config.localName,
                          tagName);
                      if (localNSMap) {
                  ...
                  default:
                    ...
                    var currentNSMap = parseStack[parseStack.length -
                    1].currentNSMap;
                    //elStartEnd
                    var end = parseElementStartPart(source, tagStart, el,
                        currentNSMap, entityReplacer, errorHandler);
                    var len = el.length;
                    ...
                    if (el.uri === 'http://www.w3.org/1999/xhtml' &&
                        !el.closed) {
          ...
          function parseElementStartPart(
              source, start, el, currentNSMap, entityReplacer, errorHandler) {
            var attrName;
            var value;
            var p = ++start;
            var s = S_TAG; //status
                  ...
                  switch (s) {
                    ...
                    case S_ATTR_SPACE:
                      ...
                      if (s == S_ATTR_NOQUOT_VALUE) {
                        ...
                        el.add(attrName,
                            value.replace(/&#?\w+;/g, entityReplacer), start);
                      } else {
                        if (currentNSMap[''] !==
                            'http://www.w3.org/1999/xhtml' ||
                            !value.match(/^(?:disabled|checked|selected)$/i)) {
                          errorHandler.warning(
                              'attribute "' + value + '" missed value!! "' +
                              value + '" instead!!');
                        }
                  ...
                  if (c <= ' ') {
                    ...
                    switch (s) {
                      ...
                      case S_ATTR_SPACE:
                        ...
                        if (currentNSMap[''] !==
                            'http://www.w3.org/1999/xhtml' || !attrName.match(
          ...
          function parseHtmlSpecialContent(
              source, elStartEnd, tagName, entityReplacer, domBuilder) {
          ...
          if ( !(_set_proto_({}, _set_proto_.prototype) instanceof
              _set_proto_)) {
            ...
            _createClass(Locations, [
              {
                  ...
                  var parser = function parser(node) {
                    ...
                    while (pos < len) {
                      ...
                      if (pos + dist >= len) {
                        ...
                        range.endOffset = pos;
                        // cfi = section.cfiFromRange(range);
                        var cfi = new _epubcfi2.default(range,
                            cfiBase).toString();
                        locations.push(cfi);
                        counter = 0;
                      }
                ...
                value: function locationFromCfi(cfi) {
                  ...
                  loc = (0, _core.locationOf)(cfi, this._locations,
            ...
            _createClass(Packaging, [
              {
                ...
                value: function parse(packageDocument) {
                  ...
                  this.uniqueIdentifier = this.findUniqueIdentifier(
                      packageDocument);
                ...
                value: function parseMetadata(xml) {
                  ...
                  metadata.description = this.getElementText(xml,
                      'description');
                  ...
                  metadata.modified_date = this.getPropertyText(xml,
                      'dcterms:modified');

                  metadata.layout = this.getPropertyText(xml,
                      'rendition:layout');
                  metadata.orientation = this.getPropertyText(xml,
                      'rendition:orientation');
                  metadata.flow = this.getPropertyText(xml, 'rendition:flow');
                  metadata.viewport = this.getPropertyText(xml,
                      'rendition:viewport');
                  metadata.media_active_class = this.getPropertyText(xml,
                      'media:active-class');
                ...
                value: function findUniqueIdentifier(packageXml) {
                  ...
                  var identifier = packageXml.getElementById(
                      uniqueIdentifierId);
                  if ( !identifier) {
                    return '';
                  }
            ...
            _createClass(Navigation, [
              {
                ...
                value: function parseNav(navHtml) {
                  var navElement = (0, _core.querySelectorByType)(navHtml,
                      'nav', 'toc');
                ...
                value: function navItem(item) {
                  ...
                  if (parentItem) {
                    ...
                    if ( !parent) {
                      var parentContent = (0, _core.filterChildren)(parentItem,
                          'a', true);
                      parent = parentContent &&
                          parentContent.getAttribute('href');
                    }
                  }

                  while ( !parent && parentItem) {
                    parentItem = (0, _core.getParentByTagName)(parentItem,
                        'li');
                    if (parentItem) {
                      parent = parentItem.getAttribute('id');
                      if ( !parent) {
                        var _parentContent = (0, _core.filterChildren)(
                            parentItem, 'a', true);
                        parent = _parentContent &&
                            _parentContent.getAttribute('href');
                      }
                    }
                  }
                ...
                value: function landmarkItem(item) {
                  ...
                  var type = content.getAttributeNS(
                      'http://www.idpf.org/2007/ops', 'type') || undefined;
                ...
                value: function ncxItem(item) {
                  ...
                  if (parentNode && (parentNode.nodeName === 'navPoint' ||
                      parentNode.nodeName.split(':').slice(-1)[0] ===
                      'navPoint')) {
            ...
            _createClass(Resources, [
              {
                ...
                value: function split() {
                  ...
                  this.html = this.resources.filter(function(item) {
                    if (item.type === 'application/xhtml+xml' || item.type ===
                        'text/html') {
                      return true;
                    }
                  });
                ...
                value: function replaceCss(archive, resolver) {
                  ...
                  this.cssUrls.forEach(function(href) {
                    var replacement = this.createCssFile(href, archive,
                        resolver).then(function(replacementUrl) {
                ...
                value: function createCssFile(href) {
                  ...
                  return textResponse.then(function(text) {
                    ...
                    text = (0, _replacements.substitute)(text, relUrls,
                ...
                value: function substitute(content, url) {
                  ...
                  return (0, _replacements.substitute)(content, relUrls,
                      this.replacementUrls);
                },
              }, {
                key: 'destroy',
            ...
            _createClass(PageList, [
              {
                ...
                value: function pageFromCfi(cfi) {
                  ...
                  var index = (0, _core.indexOfSorted)(cfi, this.locations,
                      this.epubcfi.compare);
                  if (index != -1) {
                    pg = this.pages[index];
                  } else {
                    ...
                    index = (0, _core.locationOf)(cfi, this.locations,
                        this.epubcfi.compare);
        ...
        /***/ (function(module, exports, __webpack_require__) {
          ...
          var Layout = function() {
            function Layout(settings) {
              ...
              if (settings.flow === 'scrolled' || settings.flow ===
                  'scrolled-continuous' || settings.flow === 'scrolled-doc') {
                this._flow = 'scrolled';
              } else {
            ...
            _createClass(Layout, [
              {
                ...
                value: function flow(_flow) {
                  if (typeof _flow != 'undefined') {
                    if (_flow === 'scrolled' || _flow ===
                        'scrolled-continuous' || _flow === 'scrolled-doc') {
                      this._flow = 'scrolled';
                    } else {
                      this._flow = 'paginated';
                    }
                ...
                value: function calculate(_width, _height, _gap) {
                  ...
                  if (this.name === 'reflowable' && this._flow ===
                      'paginated' && !(_gap >= 0)) {
                ...
                value: function format(contents) {
                  ...
                  if (this.name === 'pre-paginated') {
                    ...
                    formating = contents.columns(this.width, this.height,
                ...
                value: function update(props) {
                  ...
                  if (Object.keys(props).length > 0) {
                    ...
                    this.emit(_constants.EVENTS.LAYOUT.UPDATED, newProps,
                        props);
                  }
                },
              }]);
            ...
            _createClass(Themes, [
              {
                ...
                value: function register() {
                  ...
                  if (arguments.length === 1 && _typeof(arguments[0]) ===
                      'object') {
                  ...
                  if (arguments.length === 2 && _typeof(arguments[1]) ===
                      'object') {
                ...
                value: function _default(theme) {
                  ...
                  if ((typeof theme === 'undefined' ? 'undefined' : _typeof(
                      theme)) === 'object') {
                ...
                value: function override(name, value, priority) {
                  ...
                  contents.forEach(function(content) {
                    content.css(name, _this2._overrides[name].value,
                        _this2._overrides[name].priority);
                  });
                },
              }, {
                key: 'removeOverride',
                ...
                value: function overrides(contents) {
                  ...
                  for (var rule in overrides) {
                    if (overrides.hasOwnProperty(rule)) {
                      contents.css(rule, overrides[rule].value,
            ...
            _createClass(Annotations, [
              {
                key: 'add',
                value: function add(
                    type, cfiRange, data, cb, className, styles) {
                ...
                value: function _removeFromAnnotationBySectionIndex(
                  ...
                  this._annotationsBySectionIndex[sectionIndex] = this._annotationsAt(
                      sectionIndex).filter(function(h) {
                    return h !== hash;
                  });
                },
                ...
                value: function highlight(
                    cfiRange, data, cb, className, styles) {
                  return this.add('highlight', cfiRange, data, cb, className,
                      styles);
                },
                ...
                value: function underline(
                    cfiRange, data, cb, className, styles) {
                  return this.add('underline', cfiRange, data, cb, className,
                      styles);
                },
                ...
                key: 'each',
                value: function each() {
                  return this._annotations.forEach.apply(this._annotations,
                      arguments);
                },
            ...
            _createClass(Annotation, [
              {
                ...
                value: function attach(view) {
                  ...
                  if (type === 'highlight') {
                    result = view.highlight(cfiRange, data, cb, className,
                        styles);
                  } else if (type === 'underline') {
                    result = view.underline(cfiRange, data, cb, className,
                        styles);
                  } else if (type === 'mark') {
        ...
        /***/ (function(module, exports, __webpack_require__) {
          ...
          function _inherits(subClass, superClass) {
            if (typeof superClass !== 'function' && superClass !== null) {
              throw new TypeError(
                  'Super expression must either be null or a function, not ' +
                  (typeof superClass === 'undefined' ? 'undefined' : _typeof(
                      superClass)));
            }
            subClass.prototype = Object.create(
                superClass && superClass.prototype, {
          ...
          var Highlight = exports.Highlight = function(_Mark) {
            ...
            function Highlight(range, className, data, attributes) {
              ...
              var _this = _possibleConstructorReturn(this,
                  (Highlight.__proto__ ||
                      Object.getPrototypeOf(Highlight)).call(this));
            ...
            _createClass(Highlight, [
              {
                key: 'bind',
                value: function bind(element, container) {
                  _get(Highlight.prototype.__proto__ ||
                      Object.getPrototypeOf(Highlight.prototype), 'bind', this).
          ...
          var Underline = exports.Underline = function(_Highlight) {
            ...
            function Underline(range, className, data, attributes) {
              ...
              return _possibleConstructorReturn(this, (Underline.__proto__ ||
                  Object.getPrototypeOf(Underline)).call(this, range, className,
                  data, attributes));
            }
          ...
          function contains(rect1, rect2) {
            return rect2.right <= rect1.right && rect2.left >= rect1.left &&
          ...
          function clone(e) {
            ...
            try {
              ...
              copy.initMouseEvent(e.type, false, opts.cancelable, opts.view,
                  opts.detail, opts.screenX, opts.screenY, opts.clientX,
                  opts.clientY, opts.ctrlKey, opts.altKey, opts.shiftKey,
                  opts.metaKey, opts.button, opts.relatedTarget);
              return copy;
            }
          }
 ...
 */
            ...
            _createClass(Stage, [
              {
                ...
                value: function onResize(func) {
                  ...
                  if ( !(0, _core.isNumber)(this.settings.width) ||
                ...
                value: function onOrientationChange(func) {
                  ...
                  window.addEventListener('orientationchange',
                      this.orientationChangeFunc, false);
                },
              }, {
                key: 'size',
                value: function size(width, height) {
                  ...
                  this.containerPadding = {
                    ...
                    right: parseFloat(this.containerStyles['padding-right']) ||
                        0,
                    top: parseFloat(this.containerStyles['padding-top']) || 0,
                    bottom: parseFloat(
                        this.containerStyles['padding-bottom']) || 0,
                  };
                  ...
                  if ( !_width) {
                    width = _windowBounds.width - bodyPadding.left -
                        bodyPadding.right;
                  }

                  if (this.settings.fullsize && !_height || !_height) {
                    height = _windowBounds.height - bodyPadding.top -
                        bodyPadding.bottom;
                  }

                  return {
                    width: width - this.containerPadding.left -
                        this.containerPadding.right,
                    height: height - this.containerPadding.top -
                ...
                value: function addStyleRules(selector, rulesArray) {
                  ...
                  this.sheet.insertRule(scope + selector + ' {' + rules + '}',
                      0);
                },
              }, {
                key: 'axis',
                ...
                value: function overflow(_overflow) {
                  if (this.container) {
                    if (_overflow === 'scroll' && this.settings.axis ===
                        'vertical') {
                      this.container.style['overflow-y'] = _overflow;
                      this.container.style['overflow-x'] = 'hidden';
                    } else if (_overflow === 'scroll' && this.settings.axis ===
                        'horizontal') {
        ...
        /***/ (function(module, exports, __webpack_require__) {
          ...
          (function(global) {
            ...
            var freeGlobal = (typeof global === 'undefined'
                ? 'undefined'
                : _typeof(global)) == 'object' && global && global.Object ===
                Object && global;
        ...
        /***/ (function(module, exports, __webpack_require__) {
          ...
          function toNumber(value) {
            ...
            return isBinary || reIsOctal.test(value) ? freeParseInt(
                value.slice(2), isBinary ? 2 : 8) : reIsBadHex.test(value)
                ? NAN
                : +value;
          }
        ...
        /***/ (function(module, exports, __webpack_require__) {
          ...
          function isSymbol(value) {
            return (typeof value === 'undefined' ? 'undefined' : _typeof(
                value)) == 'symbol' || isObjectLike(value) &&
            ...
            _createClass(Views, [
              {
                ...
                value: function prepend(view) {
                  ...
                  if (this.container) {
                    this.container.insertBefore(view.element,
...
// easing equations from https://github.com/danro/easing-js/blob/master/easing.js
            ...
            _createClass(Snap, [
              {
                ...
                value: function setup(manager) {
                  ...
                  this.manager.settings.afterScrolledTimeout = this.settings.duration *
                      2;
                ...
                value: function addListeners() {
                  ...
                  this.scroller.addEventListener('touchstart',
                      this._onTouchStart, { passive: true });
                ...
                value: function removeListeners() {
                  ...
                  this.scroller.removeEventListener('touchmove',
                      this._onTouchMove, { passive: true });
                  this.off('touchmove', this._onTouchMove);
                  this._onTouchMove = undefined;

                  this.scroller.removeEventListener('touchend',
                      this._onTouchEnd, { passive: true });
                  this.off('touchend', this._onTouchEnd);
                  this._onTouchEnd = undefined;

                  this.manager.off(_constants.EVENTS.MANAGERS.ADDED,
                      this._afterDisplayed);
                ...
                value: function wasSwiped() {
                  ...
                  if (absolute <= this.settings.minDistance || absolute >=
                      snapWidth) {
                    return 0;
                  }
                ...
                key: 'snap',
                value: function snap() {
                  var howMany = arguments.length > 0 && arguments[0] !==
                ...
                value: function scrollTo() {
                  var left = arguments.length > 0 && arguments[0] !== undefined
                      ? arguments[0]
                      : 0;
                  var top = arguments.length > 1 && arguments[1] !== undefined
                      ? arguments[1]
                      : 0;
            ...
            _createClass(Archive, [
              {
                ...
                value: function openUrl(zipUrl, isBase64) {
                  return (0, _request2.default)(zipUrl, 'binary').
                      then(function(data) {
            ...
            _createClass(Store, [
              {
                ...
                value: function add(resources, force) {
                  ...
                  var mapped = resources.resources.map(function(item) {
                    ...
                    return _this.storage.getItem(encodedUrl).
                        then(function(item) {
                          if ( !item || force) {
                            return _this.requester(url, 'binary').
                                then(function(data) {
                                  return _this.storage.setItem(encodedUrl,
                                      data);
                                });
                          } else {
                            return item;
                ...
                value: function put(url, withCredentials, headers) {
                  ...
                  return this.storage.getItem(encodedUrl).
                      then(function(result) {
                        if ( !result) {
                          return _this2.requester(url, 'binary',
                              withCredentials, headers).then(function(data) {
                ...
                value: function request(url, type, withCredentials, headers) {
                  ...
                  if (this.online) {
                    // From network
                    return this.requester(url, type, withCredentials, headers).
                        then(function(data) {
        ...
        /***/ (function(module, exports) {
          ...
          throw new Error(
              'Module build failed: Error: Couldn\'t find preset "es2015-loose" relative to directory "E:\\\\epub.js\\\\node_modules\\\\localforage"\n    at E:\\epub.js\\node_modules\\babel-core\\lib\\transformation\\file\\options\\option-manager.js:293:19\n    at Array.map (<anonymous>)\n    at OptionManager.resolvePresets (E:\\epub.js\\node_modules\\babel-core\\lib\\transformation\\file\\options\\option-manager.js:275:20)\n    at OptionManager.mergePresets (E:\\epub.js\\node_modules\\babel-core\\lib\\transformation\\file\\options\\option-manager.js:264:10)\n    at OptionManager.mergeOptions (E:\\epub.js\\node_modules\\babel-core\\lib\\transformation\\file\\options\\option-manager.js:249:14)\n    at OptionManager.init (E:\\epub.js\\node_modules\\babel-core\\lib\\transformation\\file\\options\\option-manager.js:368:12)\n    at File.initOptions (E:\\epub.js\\node_modules\\babel-core\\lib\\transformation\\file\\index.js:212:65)\n    at new File (E:\\epub.js\\node_modules\\babel-core\\lib\\transformation\\file\\index.js:135:24)\n    at Pipeline.transform (E:\\epub.js\\node_modules\\babel-core\\lib\\transformation\\pipeline.js:46:16)\n    at transpile (E:\\epub.js\\node_modules\\babel-loader\\lib\\index.js:50:20)\n    at Object.module.exports (E:\\epub.js\\node_modules\\babel-loader\\lib\\index.js:173:20)');
            ...
            _createClass(DisplayOptions, [
              {
                ...
                value: function parse(displayOptionsDocument) {
                  ...
                  var displayOptionsNode = (0, _core.qs)(displayOptionsDocument,
                      'display_options');
        ...
        /***/ (function(module, exports, __webpack_require__) {
          ...
          (function(global) {
              ...
              var polyfillURLSearchParams = function polyfillURLSearchParams() {
                ...
                var URLSearchParams = function URLSearchParams(searchString) {
                  Object.defineProperty(this, '_entries',
                      { writable: true, value: {} });
                  var typeofSearchString = typeof searchString === 'undefined'
                      ? 'undefined'
                      : _typeof(searchString);
                  ...
                  } else if (searchString !== null && typeofSearchString ===
                      'object') {
                    if (Object.prototype.toString.call(searchString) ===
                        '[object Array]') {
                      for (var i = 0; i < searchString.length; i++) {
                        var entry = searchString[i];
                        if (Object.prototype.toString.call(entry) ===
                            '[object Array]' || entry.length !== 2) {
            ...
            'undefined' ? window : typeof self !== 'undefined'
                ? self
                : undefined);
            ...
            (function(global) {
              ...
              var polyfillURL = function polyfillURL() {
                ...
                var URL = function URL(url, base) {
                  ...
                  var doc = document,
                      baseElement;
                  if (base && (global.location === void 0 || base !==
                    ...
                    try {
                      if (baseElement.href.indexOf(base) !== 0) throw new Error(
                          baseElement.href);
                    } catch (err) {
                      throw new Error(
                ...
                Object.defineProperties(proto, {
                  ...
                  'origin': {
                    get: function get() {
                      ...
                      // 8080 != 80 && 8080 != ''
                      var addPortToOrigin = this._anchorElement.port !=
                          expectedPort && this._anchorElement.port !== '';

                      return this._anchorElement.protocol + '//' +
                          this._anchorElement.hostname + (addPortToOrigin
              ...
              if (global.location !== void 0 &&
                  !('origin' in global.location)) {
